...
source_github_items: [
     {
          ...
          source_projects: [
                         ...
                         {
                              source_user: "mrackwitz",
                              source_repo: "MRProgress",
                              source_imgs: [
                         ...
                         {
                              source_user: "TransitApp",
                              source_repo: "SVProgressHUD",
                              source_imgs: [
                         ...
                         {
                              source_user: "Marxon13",
                              source_repo: "M13ProgressSuite",
                              source_imgs: [
     ...
     },
     {
          ...
          source_projects: [
                         {
                              source_user: "romaonthego",
                              source_repo: "RESideMenu",
                              source_imgs: [
                         ...
                         {
                              source_user: "erichoracek",
                              source_repo: "MSDynamicsDrawerViewController",
                              source_imgs: [
                         ...
                         {
                              source_user: "mutualmobile",
                              source_repo: "MMDrawerController",
                              source_imgs: [
                         ...
                         {
                              source_user: "pkluz",
                              source_repo: "PKRevealController",
                              source_imgs: [
                         ...
                         {
                              source_user: "romaonthego",
                              source_repo: "REFrostedViewController",
                              source_imgs: [
                         ...
                         {
                              source_user: "JVillella",
                              source_repo: "JVFloatingDrawer",
                              source_imgs: [
...
<div>
	...
	{% for github_item in page.source_github_items %}
		...
		{% for project in github_item.source_projects %}
			...
			<h4>
                <a href="//github.com/{{project.source_user}}/{{project.source_repo}}" class="btn btn-default" role="button">{{project.source_repo}}</a>
                <iframe src="https://ghbtns.com/github-btn.html?user={{project.source_user}}&repo={{project.source_repo}}&type=star&count=true" frameborder="0" scrolling="0" width="120px" height="20px"></iframe>
